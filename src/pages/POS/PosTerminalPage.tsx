    ...
    <div className="h-[calc(100vh-4rem)] grid grid-cols-1 lg:grid-cols-12 gap-4 font-mono text-xs">
      ...
      <div className="lg:col-span-7 flex flex-col gap-4 overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto bg-white rounded-xl border border-slate-200 shadow-sm">
          ...
          {productsError && (
            <div className="m-3 p-4 bg-red-50 border border-red-200 rounded-xl text-red-700 flex items-start gap-2">
          ...
          {filteredProducts.length > 0 && (
            <div className="sticky top-0 bg-slate-50 border-b border-slate-200 px-3 py-1.5 flex items-center text-[9px] font-bold text-slate-400 uppercase z-10">
          ...
          <div className="divide-y divide-slate-100">
            {filteredProducts.map((product) => (
              <button
                ...
                className="w-full flex items-center px-3 py-2 hover:bg-brand-50 active:bg-brand-100 text-left transition-colors cursor-pointer group"
              >
                <div className="flex-1 min-w-0 pr-2">
                  <div className="font-mono text-xs font-bold text-slate-900 truncate group-hover:text-brand-600">
                    {product.name}
                  </div>
                ...
                <span className="w-20 text-right font-mono text-xs font-bold text-slate-900 shrink-0">
