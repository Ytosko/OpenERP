-- Migration: 202607230003_complete_sale_function.sql
-- Atomic PostgreSQL Function for Checkout & Stock Ledger Update
...
BEGIN
  ...
  INSERT INTO public.invoices (
    ...
    v_subtotal, COALESCE(p_discount_total, 0), v_total_tax, v_grand_total, v_paid_total, v_change_total, p_notes, v_user_id
  );
